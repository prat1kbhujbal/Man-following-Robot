...
int main(int argc, char **argv)
{
    ...
    // Define a service client capabale of requesting services from "/drive_man/command_robot"
    srvClient = nh.serviceClient<drive_man::DriveToTarget>("/drive_man/command_robot");
